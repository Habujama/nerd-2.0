    ...
    <Wrapper>
      ...
      <div className='military-page'>
        ...
        {loadingStatus.filter(Boolean).length < 5 && !isLoading && (
          <span>
            ...
            <ul style={{ listStyle: 'none' }}>
              ...
              <li>
                2. Subjekt transferu vstupuje do procedury vědomě, dobrovolně a
        ...
        {loadingStatus.filter(Boolean).length > 4 && (
          <>
            <p>
              Přenos duševních struktur dokončen. Jednotka je nyní trvale vázána
              k orbitálnímu jádru EDEN. Operace byla vykonána v souladu s
              Nařízením Rady EUFORCOM č. 23/91. Subjekt je považován za{' '}
