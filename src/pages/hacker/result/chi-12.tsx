...
const [showDetails, setShowDetails] = useState<
  ...
  return (
    ...
    {showDetails === 'canteen' && (
    <LockedFile sessionId='m' password='modlitba'>
        <div className='text-block'>
          📜 Jídelníček — Kantýna Základny Promethea
          <hr />
          <ul className='list-no-bullets'>
            <li>
              Snídaně: sušené maso ze ztracených stád + rehydratovaný chléb s kousky kořenové zeleniny (pokud se podařilo nalézt)
            </li>
            <li>Oběd: fazole s konzervovaným tuňákem a kapkou oleje – požehnání, že ještě něco zůstalo</li>
            <li>Večeře: polévka z kořenů a hub + pečivo z kvasu, který přežil zkázu</li>
            <li>Nápoje: dešťová voda filtrována přes plátno, infuze bylin z okolních ruin</li>
            <li> Neděle: Zbytek z týdne.</li>
          </ul>
          <small>
            “I když svět hoří, žaludek se nezapomíná. Nezbytné jídlo je modlitbou, která drží naše tělo i ducha.”
          </small>
        </div>
    </LockedFile>
    )}
    {showDetails === 'delivery' && (
    <LockedFile sessionId='p' password='plamenomet' >
        <div className='text-block'>
          📜 Inventurní zpráva
        <hr />
        ...
        <ul>
            ...
            <li>Léky a bylinné směsi: 15 ks – od bolesti hlavy po popáleniny</li>
            <li>Munice: 450 nábojů různých ráží – nutno chránit před vlhkostí</li>
            <li>
              Plamenomety: 2 ks – stále funkční, požehnání ohně
            </li>
            <li> Sušené maso: 12 balení – uloženo ve vyhřívané komoře</li>
          </ul>
          <small>
            “Ne všechno lze spočítat, ale každý plamenomet v našem skladu je připomínkou, že Ohnivá Brigáda ještě stojí proti Defensorům.”
          </small>
        </div>
    </LockedFile>
    )}
