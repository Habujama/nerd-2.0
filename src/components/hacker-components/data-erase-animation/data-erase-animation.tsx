...
const DataEraseProgress = ({setDataErased, dataErased }:DataEraseAnimationProps) => {
  ...
  const handleErase = () => {
    ...
    setTimeout(() => (setIsErasing(false),  setDataErased(true)), 20000)
  };

  return (
    <div style={{ textAlign: "center" }}>
      <p>Pro trvalé smazání obsahu uzlu stiskněte tlačítko níže.</p>
      <p style={{color: '#FF4D4D' }}>Varování: odstranění dat je trvalé a nezvratné!</p>
      <svg
        width="400"
        height="200"
        viewBox="0 0 400 200"
